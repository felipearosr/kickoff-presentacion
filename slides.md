...
<div class="relative z-10 flex flex-col justify-center h-full text-left px-16">
  ...
  <div class="mt-10 flex items-center gap-6">
    <span class="text-sm text-white font-medium">27 / Abril / 2026</span>
...
<v-click>
<div class="p-5 rounded-2xl bg-stone-50 border border-stone-200 mb-3">
  <h3 class="text-rose-600 font-bold mb-2 text-base">Dentro del Alcance</h3>
  <ul class="text-xs space-y-1.5 text-stone-600">
    <li><strong class="text-stone-700">Página Principal</strong> — Catálogo digital de productos y sistema interactivo para la reserva de citas</li>
    <li><strong class="text-stone-700">Panel de Administración</strong> — Gestión integral de citas, catálogo, inventario de insumos y registro de usuarios</li>
    <li><strong class="text-stone-700">Notificaciones</strong> — Alertas vía correo y/o WhatsApp para solicitudes, aceptaciones o rechazos de citas</li>
    <li><strong class="text-stone-700">Integración Google Calendar</strong> — Sincronización para una gestión eficiente de horarios y disponibilidad</li>
    <li><strong class="text-stone-700">Pedidos Específicos</strong> — Opción de pedidos de productos específicos con especificaciones dentro de la misma cita</li>
  </ul>
</div>
</v-click>
...
<v-click>
<div class="p-5 rounded-2xl bg-stone-50 border border-stone-200 h-full">
  <h3 class="text-stone-400 font-bold mb-2 text-base">Condicional</h3>
  <ul class="text-xs space-y-1.5 text-stone-500">
...
<v-click>
<div class="p-5 rounded-2xl bg-stone-100 border border-stone-200 h-full">
  <h3 class="text-stone-500 font-bold mb-2 text-base">Fuera de Alcance</h3>
  <ul class="text-xs space-y-1.5 text-stone-500">
    <li><strong class="text-stone-600">Pagos</strong> — Pasarela de pagos y procesamiento de transacciones monetarias</li>
    <li><strong class="text-stone-700">Evolutivos</strong> — Nuevas versiones, actualizaciones de funcionalidades o mantenimiento post-entrega</li>
  </ul>
</div>
</v-click>
...
# Componentes globales de la Solución
...
<div class="col-span-3 space-y-3">
  ...
  <div class="p-3 rounded-xl bg-rose-50 border border-rose-200 text-center">
    <div class="text-sm font-semibold text-stone-700 leading-tight">Catálogo digital y calendario de citas</div>
  </div>
  <div class="p-3 rounded-xl bg-rose-50 border border-rose-200 text-center">
    <div class="text-sm font-semibold text-stone-700 leading-tight">Panel de administrador</div>
    <div class="text-[10px] text-stone-500 leading-tight">(gestión de citas, usuarios, inventario, catálogo)</div>
  </div>
</div>
</v-click>
...
<div class="col-span-3 space-y-3">
  ...
  <div class="p-3 rounded-xl bg-stone-800 text-center">
  ...
  <div class="p-3 rounded-xl bg-stone-50 border border-stone-200 text-center">
    <div class="text-sm font-semibold text-stone-700">Google Calendar</div>
    <div class="text-xs text-stone-500">Sincronización</div>
  </div>
  <div class="p-3 rounded-xl bg-stone-50 border border-stone-200 text-center">
    <div class="text-sm font-semibold text-stone-700">Notificaciones</div>
    <div class="text-xs text-stone-500">Correo & WhatsApp</div>
  </div>
</div>
</v-click>
...
<div class="col-span-3 space-y-3">
  ...
  <div class="p-4 rounded-xl bg-stone-50 border border-stone-200 text-center h-32 flex flex-col justify-center items-center">
    ...
    <div class="text-sm font-semibold text-stone-700">Base de datos en la nube (NEON)</div>
  </div>
</div>
</v-click>
...
<div class="mt-8 text-center">
  <div class="text-xs text-stone-400 italic">Diagrama simplificado — arquitectura sujeta a definición en Fase de Diseño</div>
  <div class="mt-4 inline-block px-4 py-1 rounded-full bg-stone-100 border border-stone-200 text-[10px] font-bold text-stone-600 uppercase tracking-widest">
...
<v-click>
<div class="p-6 rounded-2xl bg-stone-50 border border-stone-200 h-full flex flex-col">
  <h3 class="text-rose-600 font-bold mb-4 flex items-center gap-2">
    <div class="w-2 h-2 rounded-full bg-rose-600"></div> Infraestructura y Hosting
  </h3>
  <div class="space-y-4 flex-1">
    <div class="p-4 rounded-xl bg-white border border-stone-100 shadow-sm">
      <div class="text-xs font-bold text-stone-700 uppercase mb-1">Costo Operativo Mensual</div>
      <div class="text-3xl font-black text-stone-800">$0 <span class="text-xs font-medium text-stone-400">/ mes</span></div>
    </div>
    <ul class="text-xs space-y-2 text-stone-600">
      <li>&bull; Frontend en hosting estático gratuito</li>
      <li>&bull; Backend en servicios serverless (capa gratuita)</li>
      <li>&bull; Base de datos NEON (Free Tier)</li>
      <li>&bull; <strong>Resultado:</strong> Sin costos fijos de mantenimiento para el cliente.</li>
    </ul>
  </div>
</div>
</v-click>
...
<div class="p-6 rounded-2xl bg-stone-50 border border-stone-200 h-full flex flex-col">
  <h3 class="text-rose-600 font-bold mb-4 flex items-center gap-2">
    <div class="w-2 h-2 rounded-full bg-rose-600"></div> Inversión del Proyecto
  </h3>
  <div class="space-y-4 flex-1">
    <div class="p-4 rounded-xl bg-white border border-stone-100 shadow-sm">
      <div class="text-xs font-bold text-stone-700 uppercase mb-1">Rango de Inversión</div>
      <div class="text-2xl font-black text-rose-600">$100k - $150k <span class="text-xs font-medium text-stone-400">CLP</span></div>
      <div class="mt-2 p-2 rounded bg-stone-50 border border-stone-100 text-[9px] text-stone-500 leading-tight italic">
        * Monto final sujeto al esfuerzo técnico total y complejidad abordada durante el desarrollo.
      </div>
    </div>
    <div class="p-4 rounded-xl bg-white border border-stone-100 shadow-sm mt-3">
      <div class="text-xs font-bold text-stone-700 uppercase mb-1">Modalidad de Pago</div>
      <div class="text-sm font-bold text-stone-800 italic">Pago Único (contra entrega)</div>
    </div>
    <div class="text-xs space-y-3 text-stone-600">
      <p>Acuerdo de costo reducido basado en los siguientes pilares:</p>
      <div class="grid grid-cols-1 gap-2">
        <div class="px-3 py-2 rounded-lg bg-rose-50 text-rose-700 border border-rose-100 text-[10px]">
          <strong>Contexto Universitario:</strong> Proyecto desarrollado bajo marco académico (TICs II).
        </div>
        <div class="px-3 py-2 rounded-lg bg-stone-100 text-stone-600 border border-stone-200 text-[10px]">
          <strong>Perfil Independiente:</strong> Solución adaptada a trabajador independiente (no corporativo).
        </div>
        <div class="px-3 py-2 rounded-lg bg-stone-100 text-stone-600 border border-stone-200 text-[10px]">
          <strong>App Simplificada:</strong> Enfoque en MVP (Producto Mínimo Viable).
        </div>
      </div>
      <p class="mt-4 text-[10px] italic text-rose-600 font-medium">
        * El principal factor de inversión en este proyecto corresponde al <strong>tiempo dedicado</strong> por el equipo de desarrollo para la construcción y personalización de la solución.
      </p>
    </div>
  </div>
</div>
...
<div class="p-5 rounded-2xl bg-stone-50 border border-stone-200">
  ...
  <ul class="text-xs space-y-2 text-stone-600">
    <li><strong class="text-stone-700">Resistencia al cambio:</strong> Preferencia por WhatsApp. <em class="text-stone-400">Mitigación: UX intuitiva</em></li>
    <li><strong class="text-stone-700">Desviación del alcance:</strong> Tareas secundarias. <em class="text-stone-400">Mitigación: Control de Backlog</em></li>
    <li><strong class="text-stone-700">Bugs críticos:</strong> Errores en citas/stock. <em class="text-stone-400">Mitigación: Testing riguroso</em></li>
    <li><strong class="text-stone-700">Baja adopción:</strong> Producto no cumple expectativas. <em class="text-stone-400">Mitigación: Feedback constante</em></li>
  </ul>
</div>
</v-click>
...
# Formas de Trabajo y Gobierno
## Coordinación y Comunicación con el Cliente

<div class="grid grid-cols-2 gap-8 mt-16">

<v-click>
<div class="p-6 rounded-2xl bg-stone-50 border border-stone-200 h-full">
  <h3 class="text-rose-600 font-bold mb-4 flex items-center gap-2">
    <div class="w-2 h-2 rounded-full bg-rose-600"></div> Canales de Comunicación
  </h3>
  <ul class="text-sm space-y-4 text-stone-600">
    <li class="flex items-start gap-3">
      <span class="text-xl">📱</span>
      <div>
        <strong class="text-stone-700">Comunicación Continua:</strong><br/>
        Grupo de WhatsApp para consultas rápidas y coordinación operativa.
      </div>
    </li>
    <li class="flex items-start gap-3">
      <span class="text-xl">🤝</span>
      <div>
        <strong class="text-stone-700">Coordinación Directa:</strong><br/>
        Juntas presenciales constantes con el Product Owner para revisión y definiciones.
      </div>
    </li>
  </ul>
</div>
...
<div class="p-6 rounded-2xl bg-stone-50 border border-stone-200 h-full">
  <h3 class="text-rose-600 font-bold mb-4 flex items-center gap-2">
    <div class="w-2 h-2 rounded-full bg-rose-600"></div> Visibilidad del Avance
  </h3>
  <ul class="text-sm space-y-4 text-stone-600">
    <li class="flex items-start gap-3">
      <span class="text-xl">🔄</span>
      <div>
        <strong class="text-stone-700">Revisiones Periódicas:</strong><br/>
        Presentación de Demos funcionales de manera frecuente (cada dos semanas).
      </div>
    </li>
    <li class="flex items-start gap-3">
      <span class="text-xl">💻</span>
      <div>
        <strong class="text-stone-700">Pruebas Interactivas:</strong><br/>
        El cliente validará los avances viendo el producto de forma presencial directamente en su celular o en el computador (localhost).
      </div>
    </li>
  </ul>
</div>
